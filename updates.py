...
def up_deep_context(model, policy_optim, critic_optim, context_optim, alpha, log_alpha, target_entropy, alpha_optim, obs_norm, g_desc_norm, anchor_g,
    ...
    sync_grads(model.current_state_encoder.message_passing_module)
    sync_grads(model.current_state_encoder.node_aggr_module)
    sync_grads(model.current_state_encoder.graph_aggr_module)
