...
def get_args():
    ...
    parser.add_argument('--normalize-goal', type=bool, default=True, help='do evaluation at the end of the epoch w/ frequency')
    parser.add_argument('--start-biased-init', type=int, default=20, help='Number of epoch before biased initializations start')
