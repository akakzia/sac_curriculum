...
def get_args():
    ...
    parser.add_argument('--start-biased-init', type=int, default=200, help='Number of epoch before biased initializations start')
    ...
    parser.add_argument('--buffer-size', type=int, default=500000, help='the size of the buffer')
