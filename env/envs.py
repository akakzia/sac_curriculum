...
PROBA_COPLANAR = 0.3  # The probability of initializing all blocks without stacks
PROBA_STACK_TWO = 0.5  # The probability of having exactly one stack of two given that there is at least one stack
