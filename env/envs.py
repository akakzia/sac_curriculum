...
PREDICATE_THRESHOLD = 0.08  # The minimal threshold to consider two blocks close to each other
PROBA_COPLANAR = 0.6  # The probability of initializing all blocks without stacks
PROBA_STACK_TWO = 0.4  # The probability of having exactly one stack of two given that there is at least one stack
...
class FetchManipulateEnv(fetch_manipulate_env.FetchManipulateEnv, utils.EzPickle):
    def __init__(self, reward_type='sparse', num_blocks=3, obj_range=0.15, model_path='fetch/stack3.xml'):
        initial_qpos = {
            'robot0:slide0': 0.405,
            'robot0:slide1': 0.48,
            'robot0:slide2': 0.0,
        ...
        fetch_manipulate_env.FetchManipulateEnv.__init__(
            ...
            obj_range=obj_range, target_range=0.15, predicate_threshold=PREDICATE_THRESHOLD,
