...
class DeepSetTD3:
    def __init__(self, env_params, args):
        ...
        self.single_phi_target_actor = SinglePhiActor(dim_phi_actor_input, 256, dim_phi_actor_output)
        self.rho_target_actor = RhoActor(dim_rho_actor_input, dim_rho_actor_output)
